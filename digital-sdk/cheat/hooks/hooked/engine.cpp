...
bool __fastcall hooks::hk_is_paused( i_engine* engine, void* edx ) {
	...
	return og::m_is_paused( engine, edx );
}

bool __fastcall hooks::hk_is_hltv( i_engine* engine, void* edx ) {
	...
	return og::m_is_hltv( engine, edx );
}