...
void __fastcall hooks::hk_paint_traverse( i_panel* vpanel, void* edx, const vgui::vpanel panel, const bool force_repaint, const bool allow_force ) {
	...
	hooks::og::m_paint_traverse( vpanel, edx, panel, force_repaint, allow_force );
