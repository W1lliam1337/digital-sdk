...
public:
	...
	{
		return g_utils->call_vfunc<unsigned int(__thiscall*)(void*)>(this, 71)(this);
	}
	...
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, unsigned long, const char*, int, int, int, int, int, int,
	...
	void unlock_cursor()
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*)>(this, 66)(this);
	}
	...
	{
		return g_utils->call_vfunc<void(__thiscall*
	...
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int, int, int)>(this, 15)(this, r, g, b, a);
	}

	void set_drawing_color(const c_color col)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int, int, int)>(this, 15)(
			this, col.r(), col.g(), col.b(), col.a());
	}

	void draw_outlined_rect(const int x, const int y, const int w, const int h)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int, int, int)>(this, 18)(this, x, y, w, h);
	}

	void draw_line(const int x1, const int y1, const int x2, const int y2)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int, int, int)>(this, 19)(this, x1, y1, x2, y2);
	}

	void draw_filled_rectangle(const int x, const int y, const int w, const int h)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int, int, int)>(this, 16)(this, x, y, w, h);
	}

	void get_text_size(const unsigned long font, const wchar_t* text, int& wide, int& tall)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, unsigned long, const wchar_t*, int&, int&)>(this, 79)(
			this, font, text, wide, tall);
	}

	void draw_text_font(const unsigned long font)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, unsigned long)>(this, 23)(this, font);
	}

	void set_text_color(const c_color col)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int, int, int)>(this, 25)(
			this, col.r(), col.g(), col.b(), col.a());
	}

	void draw_text_pos(const int x, const int y)
	{
		return g_utils->call_vfunc<void(__thiscall*)(void*, int, int)>(this, 26)(this, x, y);
	}
