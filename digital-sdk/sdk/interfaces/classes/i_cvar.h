...
public:
	...
	{
		return call_vfunc< void(__cdecl*)(void*, const c_color&, const char* ...)>(this, 25)(this, color, format, args...);
	}

	template< typename... arguments >
	void console_printf(const char* format, arguments ... args)
	{
		return call_vfunc<void(__thiscall*)(void*, const char* ...)>(this, 26)(this, format);
	}
};