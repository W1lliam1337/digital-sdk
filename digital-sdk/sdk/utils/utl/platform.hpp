...
T WordSwapC(T w)
{
    ...
    temp = ((*static_cast<uint16_t*>(&w) & 0xff00) >> 8);
    temp |= ((*static_cast<uint16_t*>(&w) & 0x00ff) << 8);
...
T DWordSwapC(T dw)
{
    ...
    temp = *static_cast<uint32_t*>(&dw) >> 24;
    temp |= ((*static_cast<uint32_t*>(&dw) & 0x00FF0000) >> 8);
    temp |= ((*static_cast<uint32_t*>(&dw) & 0x0000FF00) << 8);
    temp |= ((*static_cast<uint32_t*>(&dw) & 0x000000FF) << 24);
...
T* Construct(T* pMemory, ARG1 a1)
{
    return ::new(pMemory) T(a1);
}

template <class T, typename ARG1, typename ARG2>
T* Construct(T* pMemory, ARG1 a1, ARG2 a2)
{
    return ::new(pMemory) T(a1, a2);
}

template <class T, typename ARG1, typename ARG2, typename ARG3>
T* Construct(T* pMemory, ARG1 a1, ARG2 a2, ARG3 a3)
{
    return ::new(pMemory) T(a1, a2, a3);
}

template <class T, typename ARG1, typename ARG2, typename ARG3, typename ARG4>
T* Construct(T* pMemory, ARG1 a1, ARG2 a2, ARG3 a3, ARG4 a4)
{
    return ::new(pMemory) T(a1, a2, a3, a4);
}

template <class T, typename ARG1, typename ARG2, typename ARG3, typename ARG4, typename ARG5>
T* Construct(T* pMemory, ARG1 a1, ARG2 a2, ARG3 a3, ARG4 a4, ARG5 a5)
{
