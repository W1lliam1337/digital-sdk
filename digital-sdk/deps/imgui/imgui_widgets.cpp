        ...
        if ( !( flags & ImGuiButtonFlags_NoKeyModifiers ) || ( !g.IO.KeyCtrl && !g.IO.KeyShift && !g.IO.KeyAlt ) ) {
            ...
            if ( flags & ImGuiButtonFlags_PressedOnRelease ) {
                if ( mouse_button_released != -1 ) {
                    const bool has_repeated_at_least_once = ( flags & ImGuiButtonFlags_Repeat ) && g.IO.
                                                                                                     MouseDownDurationPrev
                        [ mouse_button_released ] >= g.IO.KeyRepeatDelay; // Repeat mode trumps on release behavior
...
static float CalcMaxPopupHeightFromItemCount( int items_count ) {
    ...
    if ( items_count <= 0 )
        return FLT_MAX;
    return ( g.FontSize + g.Style.ItemSpacing.y ) * items_count - g.Style.ItemSpacing.y + ( g.Style.WindowPadding.y *
        2 );
}
...
void ImGui::DataTypeApplyOp( ImGuiDataType data_type, int op, void* output, const void* arg1, const void* arg2 ) {
    ...
    case ImGuiDataType_S8:
        if ( op == '+' ) {
            *static_cast< ImS8* >( output ) = ImAddClampOverflow( *static_cast< const ImS8* >( arg1 ),
                                                                  *static_cast< const ImS8* >( arg2 ), IM_S8_MIN,
                                                                  IM_S8_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImS8* >( output ) = ImSubClampOverflow( *static_cast< const ImS8* >( arg1 ),
                                                                  *static_cast< const ImS8* >( arg2 ), IM_S8_MIN,
                                                                  IM_S8_MAX
                );
        }
    ...
    case ImGuiDataType_U8:
        if ( op == '+' ) {
            *static_cast< ImU8* >( output ) = ImAddClampOverflow( *static_cast< const ImU8* >( arg1 ),
                                                                  *static_cast< const ImU8* >( arg2 ), IM_U8_MIN,
                                                                  IM_U8_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImU8* >( output ) = ImSubClampOverflow( *static_cast< const ImU8* >( arg1 ),
                                                                  *static_cast< const ImU8* >( arg2 ), IM_U8_MIN,
                                                                  IM_U8_MAX
                );
        }
    ...
    case ImGuiDataType_S16:
        if ( op == '+' ) {
            *static_cast< ImS16* >( output ) = ImAddClampOverflow( *static_cast< const ImS16* >( arg1 ),
                                                                   *static_cast< const ImS16* >( arg2 ), IM_S16_MIN,
                                                                   IM_S16_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImS16* >( output ) = ImSubClampOverflow( *static_cast< const ImS16* >( arg1 ),
                                                                   *static_cast< const ImS16* >( arg2 ), IM_S16_MIN,
                                                                   IM_S16_MAX
                );
        }
    ...
    case ImGuiDataType_U16:
        if ( op == '+' ) {
            *static_cast< ImU16* >( output ) = ImAddClampOverflow( *static_cast< const ImU16* >( arg1 ),
                                                                   *static_cast< const ImU16* >( arg2 ), IM_U16_MIN,
                                                                   IM_U16_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImU16* >( output ) = ImSubClampOverflow( *static_cast< const ImU16* >( arg1 ),
                                                                   *static_cast< const ImU16* >( arg2 ), IM_U16_MIN,
                                                                   IM_U16_MAX
                );
        }
    ...
    case ImGuiDataType_S32:
        if ( op == '+' ) {
            *static_cast< ImS32* >( output ) = ImAddClampOverflow( *static_cast< const ImS32* >( arg1 ),
                                                                   *static_cast< const ImS32* >( arg2 ), IM_S32_MIN,
                                                                   IM_S32_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImS32* >( output ) = ImSubClampOverflow( *static_cast< const ImS32* >( arg1 ),
                                                                   *static_cast< const ImS32* >( arg2 ), IM_S32_MIN,
                                                                   IM_S32_MAX
                );
        }
    ...
    case ImGuiDataType_U32:
        if ( op == '+' ) {
            *static_cast< ImU32* >( output ) = ImAddClampOverflow( *static_cast< const ImU32* >( arg1 ),
                                                                   *static_cast< const ImU32* >( arg2 ), IM_U32_MIN,
                                                                   IM_U32_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImU32* >( output ) = ImSubClampOverflow( *static_cast< const ImU32* >( arg1 ),
                                                                   *static_cast< const ImU32* >( arg2 ), IM_U32_MIN,
                                                                   IM_U32_MAX
                );
        }
    ...
    case ImGuiDataType_S64:
        if ( op == '+' ) {
            *static_cast< ImS64* >( output ) = ImAddClampOverflow( *static_cast< const ImS64* >( arg1 ),
                                                                   *static_cast< const ImS64* >( arg2 ), IM_S64_MIN,
                                                                   IM_S64_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImS64* >( output ) = ImSubClampOverflow( *static_cast< const ImS64* >( arg1 ),
                                                                   *static_cast< const ImS64* >( arg2 ), IM_S64_MIN,
                                                                   IM_S64_MAX
                );
        }
    ...
    case ImGuiDataType_U64:
        if ( op == '+' ) {
            *static_cast< ImU64* >( output ) = ImAddClampOverflow( *static_cast< const ImU64* >( arg1 ),
                                                                   *static_cast< const ImU64* >( arg2 ), IM_U64_MIN,
                                                                   IM_U64_MAX
                );
        }
        if ( op == '-' ) {
            *static_cast< ImU64* >( output ) = ImSubClampOverflow( *static_cast< const ImU64* >( arg1 ),
                                                                   *static_cast< const ImU64* >( arg2 ), IM_U64_MIN,
                                                                   IM_U64_MAX
                );
        }
    ...
    case ImGuiDataType_Float:
        if ( op == '+' ) {
            *static_cast< float* >( output ) = *static_cast< const float* >( arg1 ) + *static_cast< const float* >(
                arg2 );
        }
        if ( op == '-' ) {
            *static_cast< float* >( output ) = *static_cast< const float* >( arg1 ) - *static_cast< const float* >(
    ...
    case ImGuiDataType_Double:
        if ( op == '+' ) {
            *static_cast< double* >( output ) = *static_cast< const double* >( arg1 ) + *static_cast< const double* >(
                arg2 );
        }
        if ( op == '-' ) {
            *static_cast< double* >( output ) = *static_cast< const double* >( arg1 ) - *static_cast< const double* >(
...
int ImGui::DataTypeCompare( ImGuiDataType data_type, const void* arg_1, const void* arg_2 ) {
    switch ( data_type ) {
    case ImGuiDataType_S8:
        return DataTypeCompareT< ImS8 >( static_cast< const ImS8* >( arg_1 ), static_cast< const ImS8* >( arg_2 ) );
    case ImGuiDataType_U8:
        return DataTypeCompareT< ImU8 >( static_cast< const ImU8* >( arg_1 ), static_cast< const ImU8* >( arg_2 ) );
    case ImGuiDataType_S16:
        return DataTypeCompareT< ImS16 >( static_cast< const ImS16* >( arg_1 ), static_cast< const ImS16* >( arg_2 ) );
    case ImGuiDataType_U16:
        return DataTypeCompareT< ImU16 >( static_cast< const ImU16* >( arg_1 ), static_cast< const ImU16* >( arg_2 ) );
    case ImGuiDataType_S32:
        return DataTypeCompareT< ImS32 >( static_cast< const ImS32* >( arg_1 ), static_cast< const ImS32* >( arg_2 ) );
    case ImGuiDataType_U32:
        return DataTypeCompareT< ImU32 >( static_cast< const ImU32* >( arg_1 ), static_cast< const ImU32* >( arg_2 ) );
    case ImGuiDataType_S64:
        return DataTypeCompareT< ImS64 >( static_cast< const ImS64* >( arg_1 ), static_cast< const ImS64* >( arg_2 ) );
    case ImGuiDataType_U64:
        return DataTypeCompareT< ImU64 >( static_cast< const ImU64* >( arg_1 ), static_cast< const ImU64* >( arg_2 ) );
    case ImGuiDataType_Float:
        return DataTypeCompareT< float >( static_cast< const float* >( arg_1 ), static_cast< const float* >( arg_2 ) );
    case ImGuiDataType_Double:
        return DataTypeCompareT< double >( static_cast< const double* >( arg_1 ), static_cast< const double* >( arg_2 )
            );
    case ImGuiDataType_COUNT:
        break;
    }
...
bool ImGui::DataTypeClamp( ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max ) {
    switch ( data_type ) {
    case ImGuiDataType_S8:
        return DataTypeClampT< ImS8 >( static_cast< ImS8* >( p_data ), static_cast< const ImS8* >( p_min ),
                                       static_cast< const ImS8* >( p_max )
            );
    case ImGuiDataType_U8:
        return DataTypeClampT< ImU8 >( static_cast< ImU8* >( p_data ), static_cast< const ImU8* >( p_min ),
                                       static_cast< const ImU8* >( p_max )
            );
    case ImGuiDataType_S16:
        return DataTypeClampT< ImS16 >( static_cast< ImS16* >( p_data ), static_cast< const ImS16* >( p_min ),
                                        static_cast< const ImS16* >( p_max )
            );
    case ImGuiDataType_U16:
        return DataTypeClampT< ImU16 >( static_cast< ImU16* >( p_data ), static_cast< const ImU16* >( p_min ),
                                        static_cast< const ImU16* >( p_max )
            );
    case ImGuiDataType_S32:
        return DataTypeClampT< ImS32 >( static_cast< ImS32* >( p_data ), static_cast< const ImS32* >( p_min ),
                                        static_cast< const ImS32* >( p_max )
            );
    case ImGuiDataType_U32:
        return DataTypeClampT< ImU32 >( static_cast< ImU32* >( p_data ), static_cast< const ImU32* >( p_min ),
                                        static_cast< const ImU32* >( p_max )
            );
    case ImGuiDataType_S64:
        return DataTypeClampT< ImS64 >( static_cast< ImS64* >( p_data ), static_cast< const ImS64* >( p_min ),
                                        static_cast< const ImS64* >( p_max )
            );
    case ImGuiDataType_U64:
        return DataTypeClampT< ImU64 >( static_cast< ImU64* >( p_data ), static_cast< const ImU64* >( p_min ),
                                        static_cast< const ImU64* >( p_max )
            );
    case ImGuiDataType_Float:
        return DataTypeClampT< float >( static_cast< float* >( p_data ), static_cast< const float* >( p_min ),
                                        static_cast< const float* >( p_max )
            );
    case ImGuiDataType_Double:
        return DataTypeClampT< double >( static_cast< double* >( p_data ), static_cast< const double* >( p_min ),
...
bool ImGui::DragBehavior( ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min,
    ...
    if ( g.ActiveId == id ) {
        ...
        if ( g.ActiveIdSource == ImGuiInputSource_Mouse && !g.IO.MouseDown[ 0 ] )
            ClearActiveID( );
        else if ( g.ActiveIdSource == ImGuiInputSource_Nav && g.NavActivatePressedId == id && !g.
    ...
    case ImGuiDataType_S8:
    {
        ...
        bool r = DragBehaviorT< ImS32, ImS32, float >( ImGuiDataType_S32, &v32, v_speed,
                                                       p_min ? *static_cast< const ImS8* >( p_min ) : IM_S8_MIN,
                                                       p_max ? *static_cast< const ImS8* >( p_max ) : IM_S8_MAX, format,
                                                       flags
            );
        if ( r )
            *static_cast< ImS8* >( p_v ) = static_cast< ImS8 >( v32 );
        return r;
    }
    case ImGuiDataType_U8:
    {
        ...
        bool r = DragBehaviorT< ImU32, ImS32, float >( ImGuiDataType_U32, &v32, v_speed,
                                                       p_min ? *static_cast< const ImU8* >( p_min ) : IM_U8_MIN,
                                                       p_max ? *static_cast< const ImU8* >( p_max ) : IM_U8_MAX, format,
                                                       flags
            );
        if ( r )
            *static_cast< ImU8* >( p_v ) = static_cast< ImU8 >( v32 );
        return r;
    }
    case ImGuiDataType_S16:
    {
        ...
        bool r = DragBehaviorT< ImS32, ImS32, float >( ImGuiDataType_S32, &v32, v_speed,
                                                       p_min ? *static_cast< const ImS16* >( p_min ) : IM_S16_MIN,
                                                       p_max ? *static_cast< const ImS16* >( p_max ) : IM_S16_MAX,
                                                       format, flags
            );
        if ( r )
            *static_cast< ImS16* >( p_v ) = static_cast< ImS16 >( v32 );
        return r;
    }
    case ImGuiDataType_U16:
    {
        ...
        bool r = DragBehaviorT< ImU32, ImS32, float >( ImGuiDataType_U32, &v32, v_speed,
                                                       p_min ? *static_cast< const ImU16* >( p_min ) : IM_U16_MIN,
                                                       p_max ? *static_cast< const ImU16* >( p_max ) : IM_U16_MAX,
                                                       format, flags
            );
        if ( r )
            *static_cast< ImU16* >( p_v ) = static_cast< ImU16 >( v32 );
        return r;
    }
    case ImGuiDataType_S32:
        return DragBehaviorT< ImS32, ImS32, float >( data_type, static_cast< ImS32* >( p_v ), v_speed,
                                                     p_min ? *static_cast< const ImS32* >( p_min ) : IM_S32_MIN,
                                                     p_max ? *static_cast< const ImS32* >( p_max ) : IM_S32_MAX, format,
                                                     flags
            );
    case ImGuiDataType_U32:
        return DragBehaviorT< ImU32, ImS32, float >( data_type, static_cast< ImU32* >( p_v ), v_speed,
                                                     p_min ? *static_cast< const ImU32* >( p_min ) : IM_U32_MIN,
                                                     p_max ? *static_cast< const ImU32* >( p_max ) : IM_U32_MAX, format,
                                                     flags
            );
    case ImGuiDataType_S64:
        return DragBehaviorT< ImS64, ImS64, double >( data_type, static_cast< ImS64* >( p_v ), v_speed,
                                                      p_min ? *static_cast< const ImS64* >( p_min ) : IM_S64_MIN,
                                                      p_max ? *static_cast< const ImS64* >( p_max ) : IM_S64_MAX,
                                                      format, flags
            );
    case ImGuiDataType_U64:
        return DragBehaviorT< ImU64, ImS64, double >( data_type, static_cast< ImU64* >( p_v ), v_speed,
                                                      p_min ? *static_cast< const ImU64* >( p_min ) : IM_U64_MIN,
                                                      p_max ? *static_cast< const ImU64* >( p_max ) : IM_U64_MAX,
                                                      format, flags
            );
    case ImGuiDataType_Float:
        return DragBehaviorT< float, float, float >( data_type, static_cast< float* >( p_v ), v_speed,
                                                     p_min ? *static_cast< const float* >( p_min ) : -FLT_MAX,
                                                     p_max ? *static_cast< const float* >( p_max ) : FLT_MAX, format,
                                                     flags
            );
    case ImGuiDataType_Double:
        return DragBehaviorT< double, double, double >( data_type, static_cast< double* >( p_v ), v_speed,
                                                        p_min ? *static_cast< const double* >( p_min ) : -DBL_MAX,
                                                        p_max ? *static_cast< const double* >( p_max ) : DBL_MAX,
                                                        format, flags
            );
    case ImGuiDataType_COUNT:
        break;
...
bool ImGui::DragScalar( const char* label, ImGuiDataType data_type, void* p_data, float v_speed, const void* p_min,
    ...
    if ( temp_input_is_active ) {
        ...
        const bool is_clamp_input = ( flags & ImGuiSliderFlags_AlwaysClamp ) != 0 && ( p_min == nullptr || p_max ==
            nullptr || DataTypeCompare( data_type, p_min, p_max ) < 0 );
        return TempInputScalar( frame_bb, id, label, data_type, p_data, format, is_clamp_input ? p_min : nullptr,
...
float ImGui::ScaleRatioFromValueT( ImGuiDataType data_type, TYPE v, TYPE v_min, TYPE v_max, bool is_logarithmic,
    ...
    if ( is_logarithmic ) {
        ...
        {
            float zero_point_center = ( -static_cast< float >( v_min ) ) / ( static_cast< float >( v_max ) - static_cast
                < float >( v_min ) );
            ...
            if ( v == 0.0f )
                ...
                result = ( 1.0f - static_cast< float >( ImLog( -( FLOATTYPE )v_clamped / logarithmic_zero_epsilon ) /
                    ImLog(
                        -v_min_fudged / logarithmic_zero_epsilon
                        ) ) ) * zero_point_snap_L;
            else
                result = zero_point_snap_R + ( static_cast< float >( ImLog(
                    ( FLOATTYPE )v_clamped / logarithmic_zero_epsilon
                    ) / ImLog(
                    v_max_fudged / logarithmic_zero_epsilon
    ...
    // Linear slider
    return static_cast< float >( ( FLOATTYPE )( SIGNEDTYPE )( v_clamped - v_min ) / ( FLOATTYPE )( SIGNEDTYPE )( v_max -
        v_min ) );
}
...
TYPE ImGui::ScaleValueFromRatioT( ImGuiDataType data_type, float t, TYPE v_min, TYPE v_max, bool is_logarithmic,
    ...
    if ( is_logarithmic ) {
        ...
        if ( ( v_min * v_max ) < 0.0f ) // Range crosses zero, so we have to do this in two parts
        {
            ...
            result = static_cast< TYPE >( v_min_fudged *
...
bool ImGui::SliderBehaviorT( const ImRect& bb, ImGuiID id, ImGuiDataType data_type, TYPE* v, const TYPE v_min,
    ...
    if ( !is_floating_point && v_range >= 0 ) // v_range < 0 may happen on integer overflows
        grab_sz = ImMax( static_cast< float >( slider_sz / ( v_range + 1 ) ), style.GrabMinSize );
            ...
            if ( input_delta != 0.0f ) {
                ...
                if ( decimal_precision > 0 ) {
                    ...
                    if ( ( v_range >= -100.0f && v_range <= 100.0f ) || tweak_slow )
                        input_delta = ( ( input_delta < 0.0f ) ? -1.0f : +1.0f ) / static_cast< float >( v_range );
...
bool ImGui::SliderBehavior( const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min,
    ...
    case ImGuiDataType_S8:
    {
        ...
        bool r = SliderBehaviorT< ImS32, ImS32, float >( bb, id, ImGuiDataType_S32, &v32,
                                                         ...
                                                         *static_cast< const ImS8* >( p_max ), format, flags,
                                                         out_grab_bb
            );
        if ( r )
            *static_cast< ImS8* >( p_v ) = static_cast< ImS8 >( v32 );
    ...
    case ImGuiDataType_U8:
    {
        ...
        bool r = SliderBehaviorT< ImU32, ImS32, float >( bb, id, ImGuiDataType_U32, &v32,
                                                         ...
                                                         *static_cast< const ImU8* >( p_max ), format, flags,
                                                         out_grab_bb
            );
        if ( r )
            *static_cast< ImU8* >( p_v ) = static_cast< ImU8 >( v32 );
    ...
    case ImGuiDataType_S16:
    {
        ...
        bool r = SliderBehaviorT< ImS32, ImS32, float >( bb, id, ImGuiDataType_S32, &v32,
                                                         ...
                                                         *static_cast< const ImS16* >( p_max ), format, flags,
                                                         out_grab_bb
            );
        if ( r )
            *static_cast< ImS16* >( p_v ) = static_cast< ImS16 >( v32 );
    ...
    case ImGuiDataType_U16:
    {
        ...
        bool r = SliderBehaviorT< ImU32, ImS32, float >( bb, id, ImGuiDataType_U32, &v32,
                                                         ...
                                                         *static_cast< const ImU16* >( p_max ), format, flags,
                                                         out_grab_bb
            );
        if ( r )
            *static_cast< ImU16* >( p_v ) = static_cast< ImU16 >( v32 );
    ...
    case ImGuiDataType_S32:
        ...
        return SliderBehaviorT< ImS32, ImS32, float >( bb, id, data_type, static_cast< ImS32* >( p_v ),
                                                       ...
                                                       *static_cast< const ImS32* >( p_max ), format, flags, out_grab_bb
            );
    case ImGuiDataType_U32:
        ...
        return SliderBehaviorT< ImU32, ImS32, float >( bb, id, data_type, static_cast< ImU32* >( p_v ),
                                                       ...
                                                       *static_cast< const ImU32* >( p_max ), format, flags, out_grab_bb
            );
    case ImGuiDataType_S64:
        IM_ASSERT(
        ...
        return SliderBehaviorT< ImS64, ImS64, double >( bb, id, data_type, static_cast< ImS64* >( p_v ),
                                                        ...
                                                        *static_cast< const ImS64* >( p_max ), format, flags,
                                                        out_grab_bb
            );
    case ImGuiDataType_U64:
        ...
        return SliderBehaviorT< ImU64, ImS64, double >( bb, id, data_type, static_cast< ImU64* >( p_v ),
                                                        ...
                                                        *static_cast< const ImU64* >( p_max ), format, flags,
                                                        out_grab_bb
            );
    case ImGuiDataType_Float:
        IM_ASSERT(
            *static_cast< const float* >( p_min ) >= -FLT_MAX / 2.0f && *static_cast< const float* >( p_max ) <= FLT_MAX
            / 2.0f
            );
        return SliderBehaviorT< float, float, float >( bb, id, data_type, static_cast< float* >( p_v ),
                                                       *static_cast< const float* >( p_min ),
                                                       *static_cast< const float* >( p_max ), format, flags, out_grab_bb
            );
    case ImGuiDataType_Double:
        IM_ASSERT(
            *static_cast< const double* >( p_min ) >= -DBL_MAX / 2.0f && *static_cast< const double* >( p_max ) <=
            DBL_MAX / 2.0f
            );
        return SliderBehaviorT< double, double, double >( bb, id, data_type, static_cast< double* >( p_v ),
                                                          *static_cast< const double* >( p_min ),
                                                          *static_cast< const double* >( p_max ), format, flags,
                                                          out_grab_bb
            );
    case ImGuiDataType_COUNT:
        break;
...
bool ImGui::SliderScalar( const char* label, ImGuiDataType data_type, void* p_data, const void* p_min,
    ...
    if ( !temp_input_is_active ) {
        ...
        const bool input_requested_by_tabbing = temp_input_allowed && ( g.LastItemData.StatusFlags &
            ImGuiItemStatusFlags_FocusedByTabbing ) != 0;
        const bool clicked = hovered && IsMouseClicked( 0, id );
        const bool make_active = ( input_requested_by_tabbing || clicked || g.NavActivateId == id || g.
            NavActivateInputId == id );
...
bool ImGui::InputInt( const char* label, int* v, int step, int step_fast, ImGuiInputTextFlags flags ) {
    ...
    return InputScalar( label, ImGuiDataType_S32, v, step > 0 ? &step : nullptr, step_fast > 0 ? &step_fast : nullptr,
                        format, flags
        );
}
...
bool ImGui::InputText( const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags,
    ...
    return InputTextEx( label, nullptr, buf, static_cast< int >( buf_size ), ImVec2( 0, 0 ), flags, callback, user_data
        );
}
...
void ImGuiInputTextCallbackData::InsertChars( int pos, const char* new_text, const char* new_text_end ) {
    ...
    const int new_text_len = new_text_end ? new_text_end - new_text : static_cast< int >( strlen( new_text ) );
...
static bool InputTextFilterCharacter( unsigned int* p_char, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback,
    ...
    if ( apply_named_filters && ( flags & ( ImGuiInputTextFlags_CharsDecimal | ImGuiInputTextFlags_CharsHexadecimal |
        ...
        ImGuiContext& g = *GImGui;
        const unsigned c_decimal_point = static_cast< unsigned int >( g.PlatformLocaleDecimalPoint );
...
bool ImGui::InputTextEx( const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg,
    ...
    const bool input_requested_by_nav = ( g.ActiveId != id ) && ( ( g.NavActivateInputId == id ) || ( g.NavActivateId ==
        id && g.NavInputSource == ImGuiInputSource_Keyboard ) );
    ...
    const bool user_scroll_active = is_multiline && state != nullptr && g.ActiveId == GetWindowScrollbarID(
    ...
    const bool is_displaying_hint = ( hint != nullptr && ( buf_display_from_state ? state->TextA.Data : buf )[ 0 ] ==
        0 );
    ...
    if ( g.ActiveId == id && !g.ActiveIdIsJustActivated && !clear_active_id ) {
        ...
        const bool is_copy = ( Shortcut( ImGuiMod_Shortcut | ImGuiKey_C, id ) ||
            Shortcut( ImGuiMod_Ctrl | ImGuiKey_Insert, id ) ) && !is_password && ( !is_multiline || state->
            HasSelection( ) );
        const bool is_paste = ( Shortcut( ImGuiMod_Shortcut | ImGuiKey_V, id, f_repeat ) || Shortcut(
            ImGuiMod_Shift | ImGuiKey_Insert, id, f_repeat
            ) ) && !is_readonly;
        const bool is_undo = ( Shortcut( ImGuiMod_Shortcut | ImGuiKey_Z, id, f_repeat ) ) && !is_readonly &&
            is_undoable;
        const bool is_redo = ( Shortcut( ImGuiMod_Shortcut | ImGuiKey_Y, id, f_repeat ) || ( is_osx && Shortcut(
            ImGuiMod_Shortcut | ImGuiMod_Shift | ImGuiKey_Z, id, f_repeat
        ...
        const bool is_cancel = Shortcut( ImGuiKey_Escape, id, f_repeat ) || ( nav_gamepad_active && Shortcut(
            ImGuiKey_NavGamepadCancel, id, f_repeat
            ) );
        ...
        if ( IsKeyPressed( ImGuiKey_LeftArrow ) ) {
            ...
            if ( io.SetClipboardTextFn ) {
                ...
                auto clipboard_data = static_cast< char* >( IM_ALLOC( clipboard_data_len * sizeof(char) ) );
            ...
            if ( const char* clipboard = GetClipboardText( ) ) {
                ...
                auto clipboard_filtered = static_cast< ImWchar* >( IM_ALLOC( (clipboard_len + 1) * sizeof(ImWchar) ) );
            ...
            if ( ( flags & ( ImGuiInputTextFlags_CallbackCompletion | ImGuiInputTextFlags_CallbackHistory |
                ...
                if ( event_flag ) {
                    ...
                    if ( buf_dirty ) {
                        ...
                        IM_ASSERT( callback_data.BufTextLen == static_cast< int >( strlen( callback_data.Buf ) ) );
        ...
        if ( render_selection ) {
            ...
            for ( const ImWchar* p = text_selected_begin; p < text_selected_end; ) {
                ...
                if ( rect_pos.y < clip_rect.y ) {
                    ...
                    if ( rect_size.x <= 0.0f )
                        rect_size.x = IM_FLOOR( g.Font->GetCharAdvance(static_cast< ImWchar >( ' ' )) * 0.50f );
...
bool ImGui::ColorEdit4( const char* label, float col[ 4 ], ImGuiColorEditFlags flags ) {
    ...
    if ( ( flags & ( ImGuiColorEditFlags_DisplayRGB | ImGuiColorEditFlags_DisplayHSV ) ) != 0 && ( flags &
        ...
        const float w_item_one = ImMax( 1.0f, IM_FLOOR(
                                            (w_inputs - (style.ItemInnerSpacing.x) * (components - 1)) / static_cast<
                                            float >( components )
                                            )
            );
    ...
    if ( ( g.LastItemData.StatusFlags & ImGuiItemStatusFlags_HoveredRect ) && !( flags &
        ImGuiColorEditFlags_NoDragDrop ) && BeginDragDropTarget( ) ) {
...
bool ImGui::ColorPicker4( const char* label, float col[ 4 ], ImGuiColorEditFlags flags, const float* ref_col ) {
    ...
    if ( flags & ImGuiColorEditFlags_PickerHueWheel ) {
        ...
        if ( IsItemActive( ) ) {
            ...
            if ( initial_dist2 >= ( wheel_r_inner - 1 ) * ( wheel_r_inner - 1 ) && initial_dist2 <= ( wheel_r_outer +
                1 ) * ( wheel_r_outer + 1 ) ) {
    ...
    if ( flags & ImGuiColorEditFlags_PickerHueWheel ) {
        ...
        int hue_cursor_segments = ImClamp( static_cast< int >( hue_cursor_rad / 1.4f ), 9, 32 );
    ...
    if ( allow_opt_picker ) {
        ...
        for ( int picker_type = 0; picker_type < 2; picker_type++ ) {
            ...
            ImGuiColorEditFlags picker_flags = ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoOptions |
                ImGuiColorEditFlags_NoLabel | ImGuiColorEditFlags_NoSidePreview | ( flags &
...
bool ImGui::TreeNodeBehavior( ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end ) {
    ...
    const float arrow_hit_x2 = ( text_pos.x - text_offset_x ) + ( g.FontSize + padding.x * 2.0f ) + style.
                                                                                                    TouchExtraPadding.x;
...
int ImGui::PlotEx( ImGuiPlotType plot_type, const char* label, float (*values_getter)( void* data, int idx ),
    ...
    if ( values_count >= values_count_min ) {
        int res_w = ImMin( static_cast< int >( frame_size.x ), values_count ) + ( ( plot_type == ImGuiPlotType_Lines )
            ? -1
            : 0 );
...
void ImGui::PlotLines( const char* label, const float* values, int values_count, int values_offset,
    ...
    PlotEx( ImGuiPlotType_Lines, label, &Plot_ArrayGetter, &data, values_count, values_offset, overlay_text, scale_min,
...
void ImGui::PlotHistogram( const char* label, const float* values, int values_count, int values_offset,
    ...
    ImGuiPlotArrayGetterData data( values, stride );
    PlotEx( ImGuiPlotType_Histogram, label, &Plot_ArrayGetter, &data, values_count, values_offset, overlay_text,
...
static bool IsRootOfOpenMenuSet( ) {
    ...
    return ( window->DC.NavLayerCurrent == upper_popup->ParentNavLayer && upper_popup->Window && ( upper_popup->Window->
                                                                                                                Flags &
        ImGuiWindowFlags_ChildMenu ) );
}
...
static void ImGui::TabBarScrollToTab( ImGuiTabBar* tab_bar, ImGuiID tab_id, ImGuiTabBarSection* sections ) {
    ...
    float scrollable_width = tab_bar->BarRect.GetWidth( ) - sections[ 0 ].Width - sections[ 2 ].Width - sections[ 1 ].
        Spacing;
...
bool ImGui::TabItemEx( ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags,
    ...
    // Update selected tab
    if ( !is_tab_button ) {
        if ( tab_appearing && ( tab_bar->Flags & ImGuiTabBarFlags_AutoSelectNewTabs ) && tab_bar->NextSelectedTabId ==
            0 )
