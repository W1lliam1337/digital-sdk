...
/*      parameters.                                                      */
/*                                                                       */
using FT_Bitmap_Size = struct FT_Bitmap_Size_
{
	FT_Short height;
	FT_Short width;
...
/*    to the former.                                                     */
/*                                                                       */
using FT_Module = struct FT_ModuleRec_*;
...
/*                                                                       */
using FT_Driver = struct FT_DriverRec_*;
...
/*    surface depths.                                                    */
/*                                                                       */
using FT_Renderer = struct FT_RendererRec_*;
...
/*    object.                                                            */
/*                                                                       */
using FT_Size = struct FT_SizeRec_*;
...
/*    character map.                                                     */
/*                                                                       */
using FT_CharMap = struct FT_CharMapRec_*;
...
/*                                                                       */
using FT_Encoding = enum FT_Encoding_
{
...
/*                   emulated similarly.                                 */
/*                                                                       */
using FT_CharMapRec = struct FT_CharMapRec_
{
	FT_Face face;
...
/*                                                                       */
using FT_Face_Internal = struct FT_Face_InternalRec_*;
...
/*                                                                       */
using FT_Size_Internal = struct FT_Size_InternalRec_*;
...
/*    @FT_Get_SubGlyph_Info.                                             */
/*                                                                       */
using FT_SubGlyph = struct FT_SubGlyphRec_*;
...
/*                                                                       */
using FT_Slot_Internal = struct FT_Slot_InternalRec_*;
...
/*                                                                       */
using FT_Parameter = struct FT_Parameter_
{
	FT_ULong tag;
	FT_Pointer data;
};
...
/*                                                                       */
using FT_Open_Args = struct FT_Open_Args_
{
	FT_UInt flags;
...
/*                                                                       */
using FT_Size_Request_Type = enum FT_Size_Request_Type_
{
	FT_SIZE_REQUEST_TYPE_NOMINAL,
	FT_SIZE_REQUEST_TYPE_REAL_DIM,
	FT_SIZE_REQUEST_TYPE_BBOX,
...
/*                                                                       */
using FT_Size_RequestRec = struct FT_Size_RequestRec_
{
...
/*                                                                       */
using FT_Size_Request = struct FT_Size_RequestRec_*;
...
/*                                                                       */
using FT_Render_Mode = enum FT_Render_Mode_
{
...
/*                                                                       */
using FT_Kerning_Mode = enum FT_Kerning_Mode_
{
