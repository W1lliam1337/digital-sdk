...
/*                                                                       */
using TT_Header = struct TT_Header_
{
...
/*                                                                       */
using TT_HoriHeader = struct TT_HoriHeader_
{
	FT_Fixed Version;
	FT_Short Ascender;
	FT_Short Descender;
...
/*    and `caret_Offset'.                                                */
/*                                                                       */
using TT_VertHeader = struct TT_VertHeader_
{
	FT_Fixed Version;
	FT_Short Ascender;
	FT_Short Descender;
...
/*                                                                       */
using TT_Postscript = struct TT_Postscript_
{
	FT_Fixed FormatType;
...
/*                                                                       */
using TT_MaxProfile = struct TT_MaxProfile_
{
	FT_Fixed version;
	FT_UShort numGlyphs;
	FT_UShort maxPoints;
...
/*                                                                       */
using FT_Sfnt_Tag = enum FT_Sfnt_Tag_
{
	FT_SFNT_HEAD,
	FT_SFNT_MAXP,
	FT_SFNT_OS2,
