...
/*                                                                       */
using TT_Init_Face_Func = FT_Error(*)(FT_Stream stream,
                                      TT_Face face,
                                      FT_Int face_index,
                                      FT_Int num_params,
                                      FT_Parameter* params);
...
/*                                                                       */
using TT_Load_Face_Func = FT_Error(*)(FT_Stream stream,
                                      TT_Face face,
                                      FT_Int face_index,
                                      FT_Int num_params,
                                      FT_Parameter* params);
...
/*                                                                       */
using TT_Done_Face_Func = void(*)(TT_Face face);
...
/*                                                                       */
using TT_Load_Any_Func = FT_Error(*)(TT_Face face,
                                     FT_ULong tag,
                                     FT_Long offset,
                                     FT_Byte* buffer,
                                     FT_ULong* length);
...
/*    glyph.                                                             */
/*                                                                       */
using TT_Find_SBit_Image_Func = FT_Error(*)(TT_Face face,
                                            FT_UInt glyph_index,
...
/*    function exit.                                                     */
/*                                                                       */
using TT_Load_SBit_Metrics_Func = FT_Error(*)(FT_Stream stream,
                                              TT_SBit_Range range,
...
/*                                                                       */
using TT_Load_SBit_Image_Func = FT_Error(*)(TT_Face face,
                                            FT_ULong strike_index,
                                            FT_UInt glyph_index,
                                            FT_UInt load_flags,
                                            FT_Stream stream,
...
/*                                                                       */
using TT_Set_SBit_Strike_Func = FT_Error(*)(TT_Face face,
                                            FT_Size_Request req,
...
/*                                                                       */
using TT_Load_Strike_Metrics_Func = FT_Error(*)(TT_Face face,
                                                FT_ULong strike_index,
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
using TT_Get_PS_Name_Func = FT_Error(*)(TT_Face face,
                                        FT_UInt idx,
                                        FT_String** PSname);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
using TT_Load_Metrics_Func = FT_Error(*)(TT_Face face,
                                         FT_Stream stream,
                                         FT_Bool vertical);
...
/*                case of error.                                         */
/*                                                                       */
using TT_Get_Metrics_Func = void(*)(TT_Face face,
                                    FT_Bool vertical,
                                    FT_UInt gindex,
                                    FT_Short* abearing,
                                    FT_UShort* aadvance);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
using TT_Get_Name_Func = FT_Error(*)(TT_Face face,
                                     FT_UShort nameid,
                                     FT_String** name);
...
/*                                                                       */
using TT_Get_Name_ID_Func = FT_Bool(*)(TT_Face face,
                                       FT_UShort nameid,
                                       FT_Int* win,
                                       FT_Int* apple);
...
/*                                                                       */
using TT_Load_Table_Func = FT_Error(*)(TT_Face face,
                                       FT_Stream stream);
...
/*    face :: A handle to the target face object.                        */
/*                                                                       */
using TT_Free_Table_Func = void(*)(TT_Face face);
 ...
 */
using TT_Face_GetKerningFunc = FT_Int(*)(TT_Face face,
                                         FT_UInt left_glyph,
                                         FT_UInt right_glyph);
...
/*                                                                       */
using SFNT_Interface = struct SFNT_Interface_
{
...
/* transitional */
using SFNT_Service = SFNT_Interface*;
