...
using FT_LSB_Adjust_Func = FT_Error(*)(FT_Face face,
                                       FT_UInt gindex,
                                       FT_Int* avalue);

using FT_RSB_Adjust_Func = FT_Error(*)(FT_Face face,
                                       FT_UInt gindex,
                                       FT_Int* avalue);

/* VVAR */

using FT_VAdvance_Adjust_Func = FT_Error(*)(FT_Face face,
                                            FT_UInt gindex,
                                            FT_Int* avalue);

using FT_TSB_Adjust_Func = FT_Error(*)(FT_Face face,
                                       FT_UInt gindex,
                                       FT_Int* avalue);

using FT_BSB_Adjust_Func = FT_Error(*)(FT_Face face,
                                       FT_UInt gindex,
                                       FT_Int* avalue);

using FT_VOrg_Adjust_Func = FT_Error(*)(FT_Face face,
                                        FT_UInt gindex,
                                        FT_Int* avalue);

/* MVAR */

using FT_Metrics_Adjust_Func = void(*)(FT_Face face);
