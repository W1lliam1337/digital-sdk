...
/*                                                                       */
using TTC_HeaderRec = struct TTC_HeaderRec_
{
	FT_ULong tag;
	FT_Fixed version;
	FT_Long count;
...
/*    tables.                                                            */
/*                                                                       */
using TT_ShortMetrics = FT_Short;
...
/*                                                                       */
using TT_GaspRec = struct TT_Gasp_
{
	FT_UShort version;
	FT_UShort numRanges;
...
#ifdef TT_CONFIG_OPTION_GX_VAR_SUPPORT
using GX_Blend = struct GX_BlendRec_*;
#endif
...
/*                                                                       */
using TT_Face = struct TT_FaceRec_*;


/* a function type used for the truetype bytecode interpreter hooks */
using TT_Interpreter = FT_Error(*)(void* exec_context);

/* forward declaration */
using TT_Loader = struct TT_LoaderRec_*;
...
/*                                                                       */
using TT_Loader_GotoTableFunc = FT_Error(*)(TT_Face face,
                                            FT_ULong tag,
                                            FT_Stream stream,
                                            FT_ULong* length);
...
/*    different.                                                         */
/*                                                                       */
using TT_Loader_StartGlyphFunc = FT_Error(*)(TT_Loader loader,
                                             FT_UInt glyph_index,
                                             FT_ULong offset,
                                             FT_UInt byte_count);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
using TT_Loader_ReadGlyphFunc = FT_Error(*)(TT_Loader loader);
...
/*    loader :: The current TrueType glyph loader object.                */
/*                                                                       */
using TT_Loader_EndGlyphFunc = void(*)(TT_Loader loader);


using TT_SbitTableType = enum TT_SbitTableType_
{
...
/*                                                                       */
using TT_FaceRec = struct TT_FaceRec_
{
	FT_FaceRec root;
...
using TT_ExecContext = struct TT_ExecContextRec_*;
...
/*                                                                       */
using TT_Size = struct TT_SizeRec_*;


/* glyph loader structure */
using TT_LoaderRec = struct TT_LoaderRec_
{
	TT_Face face;
	TT_Size size;
	FT_GlyphSlot glyph;
