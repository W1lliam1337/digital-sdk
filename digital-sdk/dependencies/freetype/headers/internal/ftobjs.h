...
using FT_CMap = struct FT_CMapRec_*;

/* handle to charmap class structure */
using FT_CMap_Class = const struct FT_CMap_ClassRec_*;

/* internal charmap object structure */
using FT_CMapRec = struct FT_CMapRec_
{
...
using FT_CMap_InitFunc = FT_Error(*)(FT_CMap cmap,
                                     FT_Pointer init_data);

using FT_CMap_DoneFunc = void(*)(FT_CMap cmap);

using FT_CMap_CharIndexFunc = FT_UInt(*)(FT_CMap cmap,
                                         FT_UInt32 char_code);

using FT_CMap_CharNextFunc = FT_UInt(*)(FT_CMap cmap,
                                        FT_UInt32* achar_code);

using FT_CMap_CharVarIndexFunc = FT_UInt(*)(FT_CMap cmap,
                                            FT_CMap unicode_cmap,
                                            FT_UInt32 char_code,
                                            FT_UInt32 variant_selector);

using FT_CMap_CharVarIsDefaultFunc = FT_Bool(*)(FT_CMap cmap,
                                                FT_UInt32 char_code,
                                                FT_UInt32 variant_selector);

using FT_CMap_VariantListFunc = FT_UInt32*
(*)(FT_CMap cmap,
    FT_Memory mem);

using FT_CMap_CharVariantListFunc = FT_UInt32*
(*)(FT_CMap cmap,
    FT_Memory mem,
    FT_UInt32 char_code);

using FT_CMap_VariantCharListFunc = FT_UInt32*
(*)(FT_CMap cmap,
    FT_Memory mem,
    FT_UInt32 variant_selector);


using FT_CMap_ClassRec = struct FT_CMap_ClassRec_
{
	FT_ULong size;
...
/*                                                                       */
using FT_Face_InternalRec = struct FT_Face_InternalRec_
{
	FT_Matrix transform_matrix;
	FT_Vector transform_delta;
	FT_Int transform_ags;
...
using FT_GlyphSlot_InternalRec = struct FT_Slot_InternalRec_
{
...
using FT_Size_InternalRec = struct FT_Size_InternalRec_
{
	void* module_data;
...
/*                                                                       */
using FT_ModuleRec = struct FT_ModuleRec_
{
...
using FT_RendererRec = struct FT_RendererRec_
{
	FT_ModuleRec root;
...
/*                                                                       */
using FT_DriverRec = struct FT_DriverRec_
{
	FT_ModuleRec root;
...
using FT_Bitmap_LcdFilterFunc = void(*)(FT_Bitmap* bitmap,
...
/*                        decrements it.                                 */
/*                                                                       */
using FT_LibraryRec = struct FT_LibraryRec_
{
...
using FT_Face_GetPostscriptNameFunc = const char*
(*)(FT_Face face);

using FT_Face_GetGlyphNameFunc = FT_Error(*)(FT_Face face,
                                             FT_UInt glyph_index,
                                             FT_Pointer buffer,
                                             FT_UInt buffer_max);

using FT_Face_GetGlyphNameIndexFunc = FT_UInt(*)(FT_Face face,
