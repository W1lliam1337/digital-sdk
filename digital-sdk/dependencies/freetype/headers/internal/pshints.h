...
using PSH_Globals = struct PSH_GlobalsRec_*;

using PSH_Globals_NewFunc = FT_Error(*)(FT_Memory memory,
                                        T1_Private* private_dict,
                                        PSH_Globals* aglobals);

using PSH_Globals_SetScaleFunc = void(*)(PSH_Globals globals,
                                         FT_Fixed x_scale,
                                         FT_Fixed y_scale,
                                         FT_Fixed x_delta,
                                         FT_Fixed y_delta);

using PSH_Globals_DestroyFunc = void(*)(PSH_Globals globals);
 ...
 *
 */
using T1_Hints = struct T1_HintsRec_*;
 ...
 *
 */
using T1_Hints_Funcs = const struct T1_Hints_FuncsRec_*;
 ...
 *
 */
using T1_Hints_OpenFunc = void(*)(T1_Hints hints);
 ...
 *
 */
using T1_Hints_SetStemFunc = void(*)(T1_Hints hints,
                                     FT_UInt dimension,
                                     FT_Fixed* coords);
 ...
 *
 */
using T1_Hints_SetStem3Func = void(*)(T1_Hints hints,
                                      FT_UInt dimension,
                                      FT_Fixed* coords);
 ...
 *
 */
using T1_Hints_ResetFunc = void(*)(T1_Hints hints,
                                   FT_UInt end_point);
 ...
 *
 */
using T1_Hints_CloseFunc = FT_Error(*)(T1_Hints hints,
                                       FT_UInt end_point);
 ...
 *
 */
using T1_Hints_ApplyFunc = FT_Error(*)(T1_Hints hints,
                                       FT_Outline* outline,
                                       PSH_Globals globals,
 ...
 *
 */
using T1_Hints_FuncsRec = struct T1_Hints_FuncsRec_
{
	T1_Hints hints;
 ...
 *
 */
using T2_Hints = struct T2_HintsRec_*;
 ...
 *
 */
using T2_Hints_Funcs = const struct T2_Hints_FuncsRec_*;
 ...
 *
 */
using T2_Hints_OpenFunc = void(*)(T2_Hints hints);
 ...
 *
 */
using T2_Hints_StemsFunc = void(*)(T2_Hints hints,
                                   FT_UInt dimension,
                                   FT_Int count,
 ...
 *
 */
using T2_Hints_MaskFunc = void(*)(T2_Hints hints,
                                  FT_UInt end_point,
                                  FT_UInt bit_count,
                                  const FT_Byte* bytes);
 ...
 *
 */
using T2_Hints_CounterFunc = void(*)(T2_Hints hints,
                                     FT_UInt bit_count,
                                     const FT_Byte* bytes);
 ...
 *
 */
using T2_Hints_CloseFunc = FT_Error(*)(T2_Hints hints,
                                       FT_UInt end_point);
 ...
 *
 */
using T2_Hints_ApplyFunc = FT_Error(*)(T2_Hints hints,
                                       FT_Outline* outline,
                                       PSH_Globals globals,
                                       FT_Render_Mode hint_mode);
 ...
 *
 */
using T2_Hints_FuncsRec = struct T2_Hints_FuncsRec_
{
	T2_Hints hints;
...
using PSHinter_Interface = struct PSHinter_Interface_
{
...
using PSHinter_Service = PSHinter_Interface*;
