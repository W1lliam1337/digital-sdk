...
/*                                                                       */
using FT_MM_Axis = struct FT_MM_Axis_
{
	FT_String* name;
	FT_Long minimum;
	FT_Long maximum;
...
/*                                                                       */
using FT_Multi_Master = struct FT_Multi_Master_
{
	FT_UInt num_axis;
	FT_UInt num_designs;
...
/*                                                                       */
using FT_Var_Axis = struct FT_Var_Axis_
{
	FT_String* name;
...
/*              for this instance.                                       */
/*                                                                       */
using FT_Var_Named_Style = struct FT_Var_Named_Style_
{
	FT_Fixed* coords;
	FT_UInt strid;
...
/*                                                                       */
using FT_MM_Var = struct FT_MM_Var_
{
	FT_UInt num_axis;
	FT_UInt num_designs;
